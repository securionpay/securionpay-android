...
internal class DonationsAdapter(private val dataSet: Array<Donation>) :
        ...
        override fun getItemOffsets(
            ...
            if (parent != null && view != null) {
                ...
                if (itemPosition >= 0 && itemPosition < totalCount - 1) {
                    outRect.right = context?.resources?.getDimensionPixelOffset(R.dimen.padding_standard) ?: 0
                }
            }
        }
    }
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        if (position == current) {
            viewHolder.layout.setBackgroundResource(R.drawable.rounded_edge_primary)
        } else {
            viewHolder.layout.setBackgroundResource(R.drawable.rounded_edge)
        }
    }
