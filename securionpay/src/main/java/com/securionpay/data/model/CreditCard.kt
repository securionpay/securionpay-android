package com.securionpay.data.model

import android.content.res.Resources
import android.graphics.drawable.Drawable
import com.securionpay.R
import com.securionpay.data.model.lookup.Card
import com.securionpay.utils.empty
import com.securionpay.utils.sanitized
...
internal class CreditCard(
    ...
    fun image(resources: Resources): Drawable {
        return when (type) {
            Type.VISA -> resources.getDrawable(R.drawable.ic_logo_visa, null)
            Type.MASTERCARD -> resources.getDrawable(R.drawable.ic_logo_mastercard, null)
            Type.AMERICAN_EXPRESS -> resources.getDrawable(R.drawable.ic_logo_americanexpress, null)
            Type.DISCOVER -> resources.getDrawable(R.drawable.ic_logo_discover, null)
            Type.UNKNOWN -> resources.getDrawable(R.drawable.ic_unknown_card, null)
            Type.DINERS -> resources.getDrawable(R.drawable.ic_logo_diners, null)
            Type.JCB -> resources.getDrawable(R.drawable.ic_logo_jcb, null)
            Type.MAESTRO -> resources.getDrawable(R.drawable.ic_logo_maestro, null)
        }
    }
