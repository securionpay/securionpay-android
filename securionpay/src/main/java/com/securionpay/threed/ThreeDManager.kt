...
import com.securionpay.data.model.threeD.DirectoryServerCertificate
import com.securionpay.threed.DebugEventListener
import com.securionpay.threed.DebugSecurityEventListener
import com.securionpay.threed.ThreeDUICustomizationFactory
import java.util.*
...
internal class ThreeDManager : ChallengeStatusReceiver {
    ...
    fun initialize(
        ...
        configParameters.addParam(null, "ProgressBarColor", "#099ef2")
